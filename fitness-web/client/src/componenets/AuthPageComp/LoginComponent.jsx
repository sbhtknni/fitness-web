        ...
        <div style={{
            ...
            <MDBContainer fluid onSubmit={handleSubmit}>
                ...
                <MDBRow className='d-flex justify-content-center align-items-center h-100 '>
                    <MDBCol col='12'>
                        <br />
                        <MDBCard className='bg-dark text-white mx-auto mb-10 ' style={{ margin:'120px' , borderRadius: '1rem' ,maxWidth: '400px', background: 'hsla(0, 0%, 100%, 0.8)', backdropFilter: 'blur(30px)' }} >
